    ...
    <main className="bg-neutral-50 min-h-min pt-6 pb-12 px-2" >
      <div className="container mx-auto text-center">
        ...
        <form action="" className="mx-auto flex flex-col justify-items-center">
          ...
          {isConnected ? <Button onClick={write} disabled={isLoading} title={isLoading ? "Подтвердите действие" : "Начать игру"} /> : <Button onClick={() => connect({ connector: connectors[2] })} title="Подключить MetaMask" />}
        </form>
      </div>
    </main>
  )
